...
## Rats
We begin with RATSL, that is a long form data of 16 rats and consecutive weight measurements. The rat's were put on different diets, and each animal’s body weight (grams) was recorded repeatedly (approximately) weekly, except in week seven when two recordings were taken) over a 9-week period.
