...
# "upper" will change the plot to see only the upper side of the "mirror"
corrplot(cor_matrix, method="circle", type = "upper")

# cl.pos = colour scale position; tl.pos = text label position (d=diagnonal). This combination also removes unnecessary correlation circles with self 
...
# plot the Boston dataset with clusters. If four clusters, col=red, green, blue, black
pairs(Boston, col = km$cluster)
pairs(Boston[1:5], col = km$cluster) # nox-crim? 
pairs(Boston[6:10], col = km$cluster) # tax-rm, age, dis and rad; also rad-rm, age, dis?
pairs(Boston[11:14], col = km$cluster)# I don't see any three clusters really...
...
pairs(Boston[1:5], col = km$cluster) # nox-crim? 
pairs(Boston[6:10], col = km$cluster) # tax-rm, age, dis and rad; also rad-rm, age, dis?
pairs(Boston[11:14], col = km$cluster) # I don't see any two clusters really...
