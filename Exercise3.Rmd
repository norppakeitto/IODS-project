...
# tabulate the target variable versus the predictions
table <- table(high_use = alc$high_use, prediction = alc$prediction)
...
# Jos malli ennustaisi kaikille false, 30 % ennustuksista menisi väärin (30 % aineistosta on suurkuluttajia)
loss_func(class = alc$high_use, prob = 1)
# 70 % ennustuksista menisi väärin

loss_func(class = alc$high_use, prob = alc$probability)

# 23 % kaikista mallin ennustuksista menee väärin
